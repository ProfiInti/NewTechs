package de.inti.app.gui.jsf;

import de.inti.app.gui.util.GuiUtil;
import de.inti.app.gui.util.MyGourmetUtil;
	...
	public void validate(FacesContext ctx, UIComponent comp, Object value)
		...
		if (value != null) {
			...
			if (minAge != null && MyGourmetUtil.getAge(date) < minAge) {
				FacesMessage msg = GuiUtil.getFacesMessage(ctx,
						FacesMessage.SEVERITY_ERROR, "validateAge.TOO_YOUNG",
						minAge);
			...
			if (maxAge != null && MyGourmetUtil.getAge(date) > maxAge) {
				FacesMessage msg = GuiUtil.getFacesMessage(ctx,
						FacesMessage.SEVERITY_ERROR, "validateAge.TOO_OLD",
						maxAge);
				throw new ValidatorException(msg);
			}
		}
